...
import { aiAnalysisBodySchema, validateJsonBody, createValidationErrorResponse } from "../_shared/validation.ts";
...
serve(async (req) => {
  ...
  try {
    ...
    const validationResult = await validateJsonBody(req, aiAnalysisBodySchema);
